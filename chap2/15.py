...
print("How many lines of ending of {0} do you want to fetch ? (max {1})".format(txtpath,max_printnum))
...
#末尾n行表示
print("Print {0} tail lines.".format(n))
print("-----------------------------")
...
cmd=["tail -n {0} {1}".format(n,txtpath)]
